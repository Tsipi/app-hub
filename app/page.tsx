    ...
    <div className="flex flex-col min-h-screen">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col items-center space-y-4 text-center">
            ...
            <div className="space-x-4">
              <Button asChild>
                <Link href="/products">{t.exploreAll}</Link>
              </Button>
          ...
          <div className="mx-auto grid max-w-5xl grid-cols-1 gap-6 md:grid-cols-3 lg:gap-12 mt-8">
            ...
            {Array.from({ length: 3 }).map((_, i) => (
              <div key={i} className="flex flex-col items-center space-y-2 rounded-lg border p-6 bg-background">
                ...
                <h3 className="text-xl font-bold">{t.features[i]}</h3>
      ...
      <section className="w-full py-12 md:py-24 lg:py-32 bg-background">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col items-center justify-center space-y-4 text-center">
            <div className="space-y-2">
              <h2 className="text-3xl font-bold tracking-tighter md:text-4xl">{t.readyToStart}</h2>
              <p className="mx-auto max-w-[700px] text-muted-foreground md:text-xl">
                {t.joinCustomers}
              </p>
            </div>
